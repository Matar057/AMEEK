...
class MentorshipRequestView(CarteRequiredMixin, LoginRequiredMixin, CreateView):
    model = Mentorship
...
class MyMentorshipsView(CarteRequiredMixin, LoginRequiredMixin, ListView):
    model = Mentorship
...
class MentorshipResponseView(CarteRequiredMixin, LoginRequiredMixin, UpdateView):
    model = Mentorship
