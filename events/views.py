...
class EventCreateView(CarteRequiredMixin, LoginRequiredMixin, CreateView):
    model = Event
...
class RegistrationConfirmedView(CarteRequiredMixin, LoginRequiredMixin, TemplateView):
