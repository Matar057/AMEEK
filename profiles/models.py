...
class Profile(models.Model):
    ...
    carte_achetee = models.BooleanField('Carte membre achetée', default=False)
    date_achat_carte = models.DateTimeField('Date d\'achat de la carte', null=True, blank=True)
